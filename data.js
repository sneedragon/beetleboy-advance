...
const NAMES = {
  ...
  pond:'Pond Beetle', pondhawk:'Eastern Pondhawk', purple:'Purple Beetle', radbro:'Radbro',
  sabertooth_longhorn:'Sabertooth Longhorn Beetle', skull:'Skull Bug', stag:'Stag Beetle',
  sunset_moth:'Sunset Moth', widow:'Black Widow',
  // Flowers — alphabetical by key
  black_lotus:'Black Lotus', camellia:'Camellia', carnation:'Chinese Pink Carnation', daisy:'Daisy',
  ...
  grenade_pin:'Grenade Pin', guitar_pick:'Guitar Pick', headphones_90s:'90s Headphones',
  ...
  cattail:'Cattail', gunpowder:'Gunpowder', moss:'Moss', nectar:'Nectar', pinecone:'Pinecone',
  ...
  stradivarius:'Stradivarius', thumb_drive:'Thumb Drive', titanium_cube:'Titanium Cube',
  // Trophies — alphabetical
  ...
  trophy_prism:'Prism Trophy', trophy_remilianet_id:'Reminet ID Trophy',
  trophy_roman_dodeca:'Roman Dodecahedron Trophy', trophy_stradivarius:'Stradivarius Trophy',
  trophy_thumb_drive:'Thumb Drive Trophy', trophy_titanium_cube:'Titanium Cube Trophy',
};
...
// ── ASSEMBLE RECIPES ──────────────────────────────────────────────────────────
const AR = [
  { out:'junk_cube_t1', ing:[{group:'junk',qty:2}] },
  { out:'junk_cube_t2', ing:[{key:'junk_cube_t1',qty:3}] },
  ...
  { out:'trophy_chinese_coin',  unique:true, ing:[{key:'junk_cube_t1',qty:2},{key:'pollen_common',qty:1}] },
  { out:'chinese_coin',    reqTrophy:'trophy_chinese_coin',    ing:[{key:'junk_cube_t1',qty:2},{key:'pollen_common',qty:1}] },
  { out:'trophy_prism',         unique:true, ing:[{key:'junk_cube_t2',qty:2},{key:'pollen_common',qty:1}] },
  { out:'prism',           reqTrophy:'trophy_prism',           ing:[{key:'junk_cube_t2',qty:2},{key:'pollen_common',qty:1}] },
  { out:'trophy_roman_dodeca',  unique:true, ing:[{key:'junk_cube_t2',qty:2},{key:'pollen_uncommon',qty:1}] },
  ...
  { out:'trophy_jade_cabbage', unique:true, ing:[{key:'chinese_coin',qty:1},{key:'roman_dodeca',qty:1}] },
  { out:'jade_cabbage',    reqTrophy:'trophy_jade_cabbage',    ing:[{key:'chinese_coin',qty:1},{key:'roman_dodeca',qty:1}] },
  { out:'trophy_thumb_drive',  unique:true, ing:[{key:'roman_dodeca',qty:1},{key:'prism',qty:1}] },
  { out:'thumb_drive',     reqTrophy:'trophy_thumb_drive',     ing:[{key:'roman_dodeca',qty:1},{key:'prism',qty:1}] },
  { out:'trophy_mokia',        unique:true, ing:[{key:'titanium_cube',qty:1},{key:'roman_dodeca',qty:1}] },
  { out:'mokia',           reqTrophy:'trophy_mokia',           ing:[{key:'titanium_cube',qty:1},{key:'roman_dodeca',qty:1}] },
  { out:'trophy_compass',      unique:true, ing:[{key:'arrowhead',qty:1},{key:'roman_dodeca',qty:1}] },
  { out:'compass',         reqTrophy:'trophy_compass',         ing:[{key:'arrowhead',qty:1},{key:'roman_dodeca',qty:1}] },

  // ── Trophies — Tier 3: item-dependent ─────────────────────────────────────
  { out:'trophy_juex_card',     unique:true, ing:[{key:'prism',qty:1},{key:'titanium_cube',qty:1}] },
  { out:'juex_card',       reqTrophy:'trophy_juex_card',       ing:[{key:'prism',qty:1},{key:'titanium_cube',qty:1}] },
  { out:'trophy_cult_medallion',unique:true, ing:[{key:'juex_card',qty:1},{key:'chinese_coin',qty:1}] },
  ...
  { out:'trophy_stradivarius', unique:true, ing:[{key:'jade_cabbage',qty:1},{key:'oriental_fan',qty:1}] },
  { out:'stradivarius',    reqTrophy:'trophy_stradivarius',    ing:[{key:'jade_cabbage',qty:1},{key:'oriental_fan',qty:1}] },
  { out:'trophy_police_badge', unique:true, ing:[{key:'arrowhead',qty:1},{key:'titanium_cube',qty:1}] },
  { out:'police_badge',    reqTrophy:'trophy_police_badge',    ing:[{key:'arrowhead',qty:1},{key:'titanium_cube',qty:1}] },
  { out:'trophy_goya_miniature',unique:true,ing:[{key:'stradivarius',qty:1},{key:'arrowhead',qty:1}] },
  ...
  { out:'trophy_milady_fumoku', unique:true, ing:[{key:'cult_medallion',qty:1},{key:'arrowhead',qty:1}] },
...
const TROPHY_REPEAT = Object.fromEntries(AR.filter(r => r.reqTrophy).map(r => [r.reqTrophy, r.out]));
